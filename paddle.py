...
The CLI reads BAIDU_PADDLEOCR_TOKEN from the environment or this repository's
.env file, submits one local file or URL, polls the async job, and writes
Markdown plus referenced images to a local output directory.
"""
